...
export default function Home(props) {
  ...
  const fetchData = async () => {
    ...
    await api
      .get(
        user._id
          ? `/api/fns/suggested/${user._id}`
          : `/api/fns/suggested`,
        {},
      )
      .then((res) => {
        setSuggestedServicesList(res.data.fns);
        console.log(res.data.fns);
      })
      .catch((e) => {
        console.log(e);
      });
    ...
    await api
      ...
      .then((res) => {
        setPopulerServices(res.data.fns);
      })
      .catch((e) => {
        console.log(e);
      });
  ...
  return (
    <div className="Home" onScroll={handleScroll}z>
      <div className="hero-section">
        ...
        <div className="hero-left">
          <div className="main-title">
            <span>Find</span> Any Furniture You Need!
          </div>
          <div className="para">
            Our platform makes it easy to find and buy furnitures
            for all your needs.{" "}
          </div>
          {/* <Ripples
            className="riple-btn"
            ...
            <div className="platform-status-wrapper">
              <div className="p-status">
                <div className="status-num">
                  {platformStatus.fns ? platformStatus.fns : "0"}+
                </div>
                <div className="status-name">Total Furniture's</div>
              </div>
              <div className="p-status">
                <div className="status-num">
                  {platformStatus.categories ? platformStatus.categories : "0"}+
                </div>
                <div className="status-name">Total Categories</div>
              </div>
              <div className="p-status">
                <div className="status-num">
      ...
      <div className="category-section">
        <div className="categories">
          <div className="title">
            ...
            <br /> on <span>Queens</span> Furniture
          </div>
      ...
      <div className="why-hire-now-section">
        <div className="title">
          Why choose <span>Queens Furniture</span> for your <span>needs</span>?
        </div>
          ...
          <div className="why-hire">
            ...
            <p>
              ...
              <div className="why-details">
                high-quality materials,ensuring durability,comfort.
              </div>
            </p>
          </div>
          <div className="why-hire">
            ...
            <p>
              ...
              <div className="why-details">
              offering various finishes, colors, and sizes.
              </div>
            </p>
          </div>
          <div className="why-hire">
            ...
            <p>
              ...
              <div className="why-details">
              easy with our flexible return and exchange policy.
              </div>
            </p>
          </div>
          <div className="why-hire">
            ...
            <p>
              ...
              <div className="why-details">
              Enjoy competitive pricing on our furnitures.
              </div>
            </p>
          </div>
        </div>
      ...
      <div className="services">
        <div className="titile">
          Suggested <span>Furnitures</span> for you
        </div>
